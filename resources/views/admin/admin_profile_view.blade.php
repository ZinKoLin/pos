                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="email" value="{{$adminData->email}}" class="form-control" id="lastname" placeholder="Enter last name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="phone" class="form-label">Phone</label>
                                                    <input type="text" name="phone" value="{{$adminData->phone}}" class="form-control" id="lastname" placeholder="Enter last name">
                                                </div>
                                            </div>
                                            <!-- end col -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="photo"  class="form-control" id="lastname" >
                                                </div>
                                            </div>
